/*
  ...
  createButton, mouseX, mouseY, keyCode, ENTER, mouseIsPressed, loadSound, io, setVolume,

*/

let bgMusic, diglettSound, whack, ham, digletts, diglett1, diglett2, diglett3, diglett4, diglett5, pic, backgroundImage, positions, button, isStarted, backgroundColor, gameIsOver, score, ham2, lives; 
...
function preload() {
  ...
  whack.setVolume(0.004);
  diglettSound = loadSound('https://cdn.glitch.com/c130eace-6f5a-4c1f-9ec8-55327d44e593%2Fdiglett.mp3?v=1628025327190');
  diglettSound.setVolume(0.004);
  bgMusic = loadSound('https://cdn.glitch.com/c130eace-6f5a-4c1f-9ec8-55327d44e593%2F5%20Minute%20Radial%20Timer%20-%20Pikachu%20Pokemon%20Edition!.mp3?v=1628107922085');
  bgMusic.setVolume(0.004);
}
...
function setup(){
  ...
  //needs filling in
  digletts = [new Diglett(40, 90), new Diglett(200, 20), new Diglett(370, 100), new Diglett(620, 60), 
              new Diglett(80, 240), new Diglett(230,180), new Diglett(500, 140), new Diglett(750, 210),
              new Diglett(200, 360), new Diglett(400, 260), new Diglett(630, 270), new Diglett(380, 440),
              new Diglett(440, 550), new Diglett(580, 490), new Diglett(690, 400)];
